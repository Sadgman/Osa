...
const links_baneados = ["is.gd", "chat.whatsapp.com", "5ne.co", "t.me", "in.ru", "ln.ru", "https://xxnx", "https://pornhub", "https://xvideos", "https://xnxx", "xnxx", "xhamster", "redtube", "youporn"]
let golpear;
    ...
    if (message.body.toLowerCase().startsWith("v ")) {
            ...
            if(counterListRequestVideo <= 1){
                try {
                    ...
                    await chat.sendSeen();
                    await chat.sendStateTyping();
                    if (search.includes('https://www.youtube.com/shorts/') || search.includes('https://youtube.com/shorts/')){
